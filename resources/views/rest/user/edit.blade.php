...
@section('content')
    ...
    <div class="result_wrap">
        <form action="{{url('rest/user/'.$field->user_id)}}" method="post">
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <label for=""><input type="radio" name="user_authority" value="0" @if($field->user_authority==0) checked @endif>管理员</label>
                            <label for=""><input type="radio" name="user_authority" value="1" @if($field->user_authority==1) checked @endif>普通用户</label>
                        </td>
                    </tr>
                    <tr>
                        <th></th>
