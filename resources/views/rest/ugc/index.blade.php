...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('rest/info')}}">首页</a> &raquo; ugc-接口列表
    </div>
    <!--面包屑导航 结束-->
            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{url('rest/ugc/'.$v->api_id).'/edit'}}">修改</a>
...
<script>
    ...
    function del(api_id) {
        layer.confirm('您确定要删除这个接口吗？', {
            ...
            $.post("{{url('rest/ugc/')}}/"+api_id,{'_method':'delete','_token':"{{csrf_token()}}"},function (data) {
                if(data.status==0){
