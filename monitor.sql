...
CREATE TABLE `monitor_project` (
  ...
  `project_name` varchar(50) CHARACTER SET utf8 DEFAULT '' COMMENT '//项目的名字',
  `project_description` varchar(255) CHARACTER SET utf8 DEFAULT '' COMMENT '项目的描述',
  `project_editor` varchar(50) CHARACTER SET utf8 DEFAULT '' COMMENT '//项目的编辑者',
  ...
  `project_url` varchar(50) CHARACTER SET utf8 DEFAULT '' COMMENT '//项目的url',
...
CREATE TABLE `monitor_ugc` (
  ...
  `api_name` varchar(50) CHARACTER SET utf8 DEFAULT '' COMMENT '//接口的名字',
  `api_description` varchar(255) CHARACTER SET utf8 DEFAULT '' COMMENT '//接口的描述',
  `api_url` varchar(50) DEFAULT '' COMMENT '//接口的url',
  `api_wiki` varchar(50) DEFAULT '' COMMENT '//接口的wiki地址',
  `api_redmine` varchar(50) DEFAULT '' COMMENT '//接口的redmine地址',
  `api_time` int(11) DEFAULT '0' COMMENT '//创建的时间',
  `api_editor` varchar(50) CHARACTER SET utf8 DEFAULT '' COMMENT '//接口作者',
  PRIMARY KEY (`api_id`)
...
-- ----------------------------
INSERT INTO `monitor_userpicture` VALUES ('3', '用户喜好', '', 'http://www.baidu.com', 'http://www.baidu.com', 'http://www.baidu.com', '1482582592', 'chenbiao');
